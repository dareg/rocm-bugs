...
SUBROUTINE PAIR_FIELD_2RM_GATHER_DEVICE_DATA_RDONLY (YDPAIR, LDNULL, LDFULL, KLON, KGPBLKS, YDFINDS, PTR, YLF, KBLKMIN, KBLKMAX) 
...
TYPE (FIELD_2RM_SHUFFLE_PAIR), POINTER :: YLPAIR
CLASS (FIELD_2RM), POINTER :: YLGATH_DUMM
...
ELSE
  ...
  CALL PAIR_FIELD_2RM_DEVICE_RDONLY (INDS, ZTRG, ZTRS)
...
SUBROUTINE PAIR_FIELD_2RM_DEVICE_RDONLY (KNDS, PTRG, PTRS)
...
END SUBROUTINE PAIR_FIELD_2RM_GATHER_DEVICE_DATA_RDONLY


SUBROUTINE PAIR_FIELD_2RM_GATHER_DEVICE_DATA_RDWR (YDPAIR, LDNULL, LDFULL, KLON, KGPBLKS, YDFINDS, PTR, YLF, KBLKMIN, KBLKMAX) 
...
ELSE
  ...
  CALL PAIR_FIELD_2RM_DEVICE_RDWR (INDS, ZTRG, ZTRS)
...
SUBROUTINE PAIR_FIELD_2RM_DEVICE_RDWR (KNDS, PTRG, PTRS)
...
END SUBROUTINE PAIR_FIELD_2RM_GATHER_DEVICE_DATA_RDWR


SUBROUTINE PAIR_FIELD_2RM_GATHER_HOST_DATA_RDONLY (YDPAIR, LDNULL, LDFULL, KLON, KGPBLKS, YDFINDS, PTR, YLF, KBLKMIN, KBLKMAX) 
...
ELSE
  ...
  CALL PAIR_FIELD_2RM_HOST_RDONLY (INDS, ZTRG, ZTRS)
...
SUBROUTINE PAIR_FIELD_2RM_HOST_RDONLY (KNDS, PTRG, PTRS)
...
END SUBROUTINE PAIR_FIELD_2RM_GATHER_HOST_DATA_RDONLY


SUBROUTINE PAIR_FIELD_2RM_GATHER_HOST_DATA_RDWR (YDPAIR, LDNULL, LDFULL, KLON, KGPBLKS, YDFINDS, PTR, YLF, KBLKMIN, KBLKMAX) 
...
ELSE
  ...
  CALL PAIR_FIELD_2RM_HOST_RDWR (INDS, ZTRG, ZTRS)
...
SUBROUTINE PAIR_FIELD_2RM_HOST_RDWR (KNDS, PTRG, PTRS)
...
END SUBROUTINE PAIR_FIELD_2RM_GATHER_HOST_DATA_RDWR
...
DO WHILE (ASSOCIATED (YDPAIR))
  ...
  IF (YDPAIR%IMODE == NRDWR) THEN
    IF (YDPAIR%IWHAT == NDEVICE) THEN
      ...
      CALL FIELD_2RM_SCATTER_DEVICE_KERNEL (INDS, PTRG, PTRS)
    ...
    ELSEIF (YDPAIR%IWHAT == NHOST) THEN
      ...
      CALL FIELD_2RM_SCATTER_HOST_KERNEL (INDS, PTRG, PTRS)
...
SUBROUTINE FIELD_2RM_SCATTER_DEVICE_KERNEL (KNDS, PTRG, PTRS)
...
SUBROUTINE FIELD_2RM_SCATTER_HOST_KERNEL (KNDS, PTRG, PTRS)
