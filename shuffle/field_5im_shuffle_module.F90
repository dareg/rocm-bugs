...
SUBROUTINE PAIR_FIELD_5IM_GATHER_DEVICE_DATA_RDONLY (YDPAIR, LDNULL, LDFULL, KLON, KGPBLKS, YDFINDS, PTR, YLF, KBLKMIN, KBLKMAX) 
...
CLASS (FIELD_5IM),              POINTER, OPTIONAL    :: YLF
...
TYPE (FIELD_5IM_SHUFFLE_PAIR), POINTER :: YLPAIR
CLASS (FIELD_5IM), POINTER :: YLGATH_DUMM
...
ELSE
  ...
  CALL PAIR_FIELD_5IM_DEVICE_RDONLY (INDS, ZTRG, ZTRS)
...
SUBROUTINE PAIR_FIELD_5IM_DEVICE_RDONLY (KNDS, PTRG, PTRS)
...
END SUBROUTINE PAIR_FIELD_5IM_GATHER_DEVICE_DATA_RDONLY


SUBROUTINE PAIR_FIELD_5IM_GATHER_DEVICE_DATA_RDWR (YDPAIR, LDNULL, LDFULL, KLON, KGPBLKS, YDFINDS, PTR, YLF, KBLKMIN, KBLKMAX) 
...
ELSE
  ...
  CALL PAIR_FIELD_5IM_DEVICE_RDWR (INDS, ZTRG, ZTRS)
...
SUBROUTINE PAIR_FIELD_5IM_DEVICE_RDWR (KNDS, PTRG, PTRS)
...
END SUBROUTINE PAIR_FIELD_5IM_GATHER_DEVICE_DATA_RDWR


SUBROUTINE PAIR_FIELD_5IM_GATHER_HOST_DATA_RDONLY (YDPAIR, LDNULL, LDFULL, KLON, KGPBLKS, YDFINDS, PTR, YLF, KBLKMIN, KBLKMAX) 
...
ELSE
  ...
  CALL PAIR_FIELD_5IM_HOST_RDONLY (INDS, ZTRG, ZTRS)
...
SUBROUTINE PAIR_FIELD_5IM_HOST_RDONLY (KNDS, PTRG, PTRS)
...
END SUBROUTINE PAIR_FIELD_5IM_GATHER_HOST_DATA_RDONLY


SUBROUTINE PAIR_FIELD_5IM_GATHER_HOST_DATA_RDWR (YDPAIR, LDNULL, LDFULL, KLON, KGPBLKS, YDFINDS, PTR, YLF, KBLKMIN, KBLKMAX) 
...
ELSE
  ...
  CALL PAIR_FIELD_5IM_HOST_RDWR (INDS, ZTRG, ZTRS)
...
SUBROUTINE PAIR_FIELD_5IM_HOST_RDWR (KNDS, PTRG, PTRS)
...
END SUBROUTINE PAIR_FIELD_5IM_GATHER_HOST_DATA_RDWR
...
DO WHILE (ASSOCIATED (YDPAIR))
  ...
  IF (YDPAIR%IMODE == NRDWR) THEN
    IF (YDPAIR%IWHAT == NDEVICE) THEN
      ...
      CALL FIELD_5IM_SCATTER_DEVICE_KERNEL (INDS, PTRG, PTRS)
    ...
    ELSEIF (YDPAIR%IWHAT == NHOST) THEN
      ...
      CALL FIELD_5IM_SCATTER_HOST_KERNEL (INDS, PTRG, PTRS)
...
SUBROUTINE FIELD_5IM_SCATTER_DEVICE_KERNEL (KNDS, PTRG, PTRS)
...
SUBROUTINE FIELD_5IM_SCATTER_HOST_KERNEL (KNDS, PTRG, PTRS)
