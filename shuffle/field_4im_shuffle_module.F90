...
SUBROUTINE PAIR_FIELD_4IM_GATHER_DEVICE_DATA_RDONLY (YDPAIR, LDNULL, LDFULL, KLON, KGPBLKS, YDFINDS, PTR, YLF, KBLKMIN, KBLKMAX) 
...
INTEGER(KIND=JPIM), POINTER :: ZTRG(:,:,:,:), ZTRS(:,:,:,:)
INTEGER(KIND=JPIM), POINTER :: PTR1(:,:,:,:)
TYPE (FIELD_4IM_SHUFFLE_PAIR), POINTER :: YLPAIR
CLASS (FIELD_4IM), POINTER :: YLGATH_DUMM
...
ELSE
  ...
  CALL PAIR_FIELD_4IM_DEVICE_RDONLY (INDS, ZTRG, ZTRS)
...
SUBROUTINE PAIR_FIELD_4IM_DEVICE_RDONLY (KNDS, PTRG, PTRS)

INTEGER(KIND=JPIM), POINTER :: PTRG(:,:,:,:)
INTEGER(KIND=JPIM), POINTER :: PTRS(:,:,:,:)
...
END SUBROUTINE PAIR_FIELD_4IM_GATHER_DEVICE_DATA_RDONLY


SUBROUTINE PAIR_FIELD_4IM_GATHER_DEVICE_DATA_RDWR (YDPAIR, LDNULL, LDFULL, KLON, KGPBLKS, YDFINDS, PTR, YLF, KBLKMIN, KBLKMAX) 
...
ELSE
  ...
  CALL PAIR_FIELD_4IM_DEVICE_RDWR (INDS, ZTRG, ZTRS)
...
SUBROUTINE PAIR_FIELD_4IM_DEVICE_RDWR (KNDS, PTRG, PTRS)
...
END SUBROUTINE PAIR_FIELD_4IM_GATHER_DEVICE_DATA_RDWR


SUBROUTINE PAIR_FIELD_4IM_GATHER_HOST_DATA_RDONLY (YDPAIR, LDNULL, LDFULL, KLON, KGPBLKS, YDFINDS, PTR, YLF, KBLKMIN, KBLKMAX) 
...
ELSE
  ...
  CALL PAIR_FIELD_4IM_HOST_RDONLY (INDS, ZTRG, ZTRS)
...
SUBROUTINE PAIR_FIELD_4IM_HOST_RDONLY (KNDS, PTRG, PTRS)
...
END SUBROUTINE PAIR_FIELD_4IM_GATHER_HOST_DATA_RDONLY


SUBROUTINE PAIR_FIELD_4IM_GATHER_HOST_DATA_RDWR (YDPAIR, LDNULL, LDFULL, KLON, KGPBLKS, YDFINDS, PTR, YLF, KBLKMIN, KBLKMAX) 
...
ELSE
  ...
  CALL PAIR_FIELD_4IM_HOST_RDWR (INDS, ZTRG, ZTRS)
...
SUBROUTINE PAIR_FIELD_4IM_HOST_RDWR (KNDS, PTRG, PTRS)
...
END SUBROUTINE PAIR_FIELD_4IM_GATHER_HOST_DATA_RDWR
...
TYPE (FIELD_4IM_SHUFFLE_PAIR), POINTER :: YLPAIR
INTEGER(KIND=JPIM), POINTER :: PTRG(:,:,:,:), PTRS(:,:,:,:)
INTEGER (KIND=JPIM), POINTER :: INDS (:,:,:)
...
DO WHILE (ASSOCIATED (YDPAIR))
  ...
  IF (YDPAIR%IMODE == NRDWR) THEN
    IF (YDPAIR%IWHAT == NDEVICE) THEN
      ...
      CALL FIELD_4IM_SCATTER_DEVICE_KERNEL (INDS, PTRG, PTRS)
    ...
    ELSEIF (YDPAIR%IWHAT == NHOST) THEN
      ...
      CALL FIELD_4IM_SCATTER_HOST_KERNEL (INDS, PTRG, PTRS)
...
SUBROUTINE FIELD_4IM_SCATTER_DEVICE_KERNEL (KNDS, PTRG, PTRS)
...
SUBROUTINE FIELD_4IM_SCATTER_HOST_KERNEL (KNDS, PTRG, PTRS)
