...
CONTAINS
  ...
  FUNCTION FIELD_2RD_COPY_FUNC (HST, DEV) RESULT (FUNC)
    ...
    IF (PRESENT (HST)) THEN
      LAST_CONTIG_DIM = FIELD_2RD_GET_LAST_CONTIGUOUS_DIMENSION (HST, 0)
      NEXT_CONTIG_DIM = FIELD_2RD_GET_LAST_CONTIGUOUS_DIMENSION (HST, LAST_CONTIG_DIM+1)
    ELSE
      LAST_CONTIG_DIM = 2
      NEXT_CONTIG_DIM = 2
    ENDIF
    ...
    SELECT CASE (LAST_CONTIG_DIM)
      CASE (0)
        FUNC => FIELD_2RD_COPY_DIM0_CONTIGUOUS 
      CASE (1)
        FUNC => FIELD_2RD_COPY_DIM1_CONTIGUOUS 
      CASE (2)
        FUNC => FIELD_2RD_COPY_DIM2_CONTIGUOUS 
      CASE DEFAULT
  ...
  SUBROUTINE FIELD_2RD_COPY (HST, DEV, MAP_DEVPTR, KDIR, QUEUE)
    ...
    FUNC => FIELD_2RD_COPY_FUNC (HST, DEV) 
