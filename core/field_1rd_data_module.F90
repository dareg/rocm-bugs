...
CONTAINS
  ...
  FUNCTION FIELD_1RD_COPY_FUNC (HST, DEV) RESULT (FUNC)
    ...
    IF (PRESENT (HST)) THEN
      LAST_CONTIG_DIM = FIELD_1RD_GET_LAST_CONTIGUOUS_DIMENSION (HST, 0)
      NEXT_CONTIG_DIM = FIELD_1RD_GET_LAST_CONTIGUOUS_DIMENSION (HST, LAST_CONTIG_DIM+1)
    ELSE
      LAST_CONTIG_DIM = 1
      NEXT_CONTIG_DIM = 1
    ENDIF
    ...
    SELECT CASE (LAST_CONTIG_DIM)
      CASE (0)
        FUNC => FIELD_1RD_COPY_DIM0_CONTIGUOUS 
      CASE (1)
        FUNC => FIELD_1RD_COPY_DIM1_CONTIGUOUS 
      CASE DEFAULT
  ...
  SUBROUTINE FIELD_1RD_COPY (HST, DEV, MAP_DEVPTR, KDIR, QUEUE)
    ...
    FUNC => FIELD_1RD_COPY_FUNC (HST, DEV) 
