...
CONTAINS
  ...
  FUNCTION FIELD_5RM_COPY_FUNC (HST, DEV) RESULT (FUNC)
    ...
    IF (PRESENT (HST)) THEN
      LAST_CONTIG_DIM = FIELD_5RM_GET_LAST_CONTIGUOUS_DIMENSION (HST, 0)
      NEXT_CONTIG_DIM = FIELD_5RM_GET_LAST_CONTIGUOUS_DIMENSION (HST, LAST_CONTIG_DIM+1)
    ELSE
      LAST_CONTIG_DIM = 5
      NEXT_CONTIG_DIM = 5
    ENDIF
    ...
    SELECT CASE (LAST_CONTIG_DIM)
      CASE (0)
        FUNC => FIELD_5RM_COPY_DIM0_CONTIGUOUS 
      CASE (1)
        FUNC => FIELD_5RM_COPY_DIM1_CONTIGUOUS 
      CASE (2)
        FUNC => FIELD_5RM_COPY_DIM2_CONTIGUOUS 
      CASE (3)
        FUNC => FIELD_5RM_COPY_DIM3_CONTIGUOUS 
      CASE (4)
        FUNC => FIELD_5RM_COPY_DIM4_CONTIGUOUS 
      CASE (5)
        FUNC => FIELD_5RM_COPY_DIM5_CONTIGUOUS 
      CASE DEFAULT
  ...
  SUBROUTINE FIELD_5RM_COPY (HST, DEV, MAP_DEVPTR, KDIR, QUEUE)
    ...
    FUNC => FIELD_5RM_COPY_FUNC (HST, DEV) 
